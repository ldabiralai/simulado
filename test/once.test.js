...
describe('mock with once parameter', function () {
  ...
  describe('mock with conditional request header', function() {

        beforeEach(function(done){
            Simulado.mock({
                    path: '/test',
                    method: 'POST',
                    conditionalRequestHeaders: { 'Authorization': 'YOLO' },
                    response: "response For Request 1",
                    once: true
                }, function() {
                       Simulado.mock({
    ...
    describe('mock with conditional request body and header', function() {
